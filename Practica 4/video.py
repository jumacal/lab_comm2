...
import math
import sip
import video_epy_block_0 as epy_block_0  # embedded python block



class video(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "video")
...
def main(top_block_cls=video, options=None):
