...
import untitled_Acumulador as Acumulador  # embedded python block
...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Acumulador = Acumulador.blk()


        ##################################################
        # Connections
        ##################################################
        self.connect((self.Acumulador, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_throttle_0, 0), (self.Acumulador, 0))
